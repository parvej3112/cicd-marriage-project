...
const MarriageCertificate = () => {
  ...
  const handleSubmitAndPrint = async (e) => {
    ...
    try {
      ...
      alert(error.response?.data?.error || "Failed to save certificate. Please try again.");
    }
  };

  const getInputStyle = (value) => ({
    fontSize: value.length > 50 ? "12px" : "12pt",
  });
          ...
          <div className="marriageForm absolute w-[21.5cm] h-[7.5cm]">
            <div className="info-header mt-[9cm] absolute w-[21.5cm] border">
              ...
              >
                ...
                {/* Witness Section */}
                <section className="flex flex-col w-[19.5cm] mt-[12.9cm] h-[5cm] absolute" id="witness-section">
                  <input
                    type="text"
                    name="groomFathersName"
                    value={formData.groomFathersName}
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={getInputStyle(formData.Vakil)}
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={getInputStyle(formData.witness1)}
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={getInputStyle(formData.witness2)}
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={getInputStyle(formData.marriagePerformer)}
                ...
                <button
                  type="submit"
                  className="absolute top-230 bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700"
                >
                  Submit & Print
                </button>
              </form>
